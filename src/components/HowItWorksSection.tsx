...
const HowItWorksSection = () => {
  ...
  const userSteps = [
    ...
    },
    {
      ...
      description:
        "Converse diretamente, alinhe expectativas e feche o acordo.",
    },
    {
      icon: CreditCard,
      step: "03",
    ...
    >
      <div className="container mx-auto px-4">
        <ScrollAnimation className="text-center mb-12">
          ...
          <h2 className="section-heading text-navy">Como Funciona</h2>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-16">
          ...
          <ScrollAnimation direction="left">
            <div className="relative">
              ...
              <div className="relative">
                {/* Connection Line */}
                <div className="absolute left-8 top-12 bottom-12 w-0.5 bg-gradient-to-b from-coral via-coral/50 to-coral/20 hidden md:block z-0"></div>
                  ...
                  {userSteps.map((step, index) => (
                    ...
                    >
                      <motion.div
                        ...
                        className="relative flex-shrink-0 bg-white rounded-2xl"
                      >
          ...
          <ScrollAnimation direction="right">
            <div className="relative">
              ...
              <div className="relative">
                {/* Connection Line */}
                <div className="absolute left-8 top-12 bottom-12 w-0.5 bg-gradient-to-b from-navy via-navy/50 to-navy/20 hidden md:block z-0"></div>
